...
var rootPtah = process.env.NODE_ENV == 'development' ? '/edu.html' : '/edu';
Vue.use(Router);
    ...
    routes: [
        {
            ...
            children: [
                ...
                // 权限日志
                {
                    ...
                    name: "auth",
                    component: {
                        template: '<el-page-auth code="edu" :unit-id="$store.state.unitId"></el-page-auth>',
                        created() {
                ...
                },
                {
                    ...
                    name: "log",
                    component: {
                        template: '<el-page-log code="edu"></el-page-log>',
                        created() {
                            this.$parent.$emit("currentPage", this.$route.path);
                        }
                    }
                ...
                // -----
                // 重定向
                { path: "/", redirect: rootPtah+ "/hello" }
            ]
        },
        { path: "/", redirect: rootPtah },
        {
            path: '*',
            component: {
